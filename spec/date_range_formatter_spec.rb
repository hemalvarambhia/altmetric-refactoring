...
RSpec.describe(DateRangeFormatter) do
  ...
  context 'when dates are the same' do
    it "formats a date range for the same day and no start or end times" do
  ...
  context 'When the year AND months are the same' do
    it "formats a date range for the same month and no start or end times" do
      formatter = DateRangeFormatter.new("2009-11-1", "2009-11-3")
      expect(formatter.to_s).to eq("1st - 3rd November 2009")
    end

    it "formats a date range for the same month with starting time and no end time" do
  ...
  context 'when the years are the same but the months are different and times are not specified' do
  ...
  context 'when the years are different' do
    it "formats a date range for different year when no times are specified" do
    ...
    it 'formats a date range for the same month in different years and no times are specified' do
